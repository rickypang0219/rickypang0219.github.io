...
<p align="center" style="text-align: justify">
    ...
    Fig (2). The Matrix Product States (MPS). The tensor {% katex %}  C^{i_1, \dots, i_N}  {% endkatex %} consists of large number of parameters {% katex %}  \sim 2^{20} {% endkatex %}. The MPS offers us a decomposition of the original tensor to multiple  matrices {% katexmm %} $ A^{i_\alpha} ${% endkatexmm %} with much smaller sizes. 
</p>
