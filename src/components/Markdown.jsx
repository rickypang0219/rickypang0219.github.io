                    ...
                    <MotionBox
                        ...
                        <Grid container>
                            <Grid item md={12} xs={12}>
                                <Stack spacing={2}>
                                    <Link to={`/blog/${blogPost.file}`} style={{ color: theme.palette.mode === 'dark' ? '#FFFFFF' : '#000000' }}>
                                        <Typography fontWeight={'bold'} fontSize={25}> {blogPost.title} </Typography>
                                    </Link>
                                    <Typography> Author: {blogPost.author} </Typography>
                                    <Typography> Created on: {blogPost.date} </Typography>
                                </Stack>
                            </Grid>
                            <Grid item>
                                <Box
                ...
                <Grid item xs={12} md={8}>
                    <Box sx={{
                        ...
                        <Stack spacing={1}>
                            ...
                            <BlogPostList blogPosts={markdowns} theme={theme} />
                        </Stack>
                    </Box>
                </Grid>
                <Grid item xs={0} md={1}>
