      ...
      <Container maxWidth="xl">
        ...
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            ...
            >
              <Link to="/" style={{ textDecoration: "none", color: theme.palette.mode === 'dark' ? '#FFFFFF' : '#000000' }}>
                <MenuItem key={"Home"} onClick={handleCloseNavMenu}>
                  <Typography textAlign="center">Home</Typography>
                </MenuItem>
              </Link>

              <Link to="/blog" style={{ textDecoration: "none", color: theme.palette.mode === 'dark' ? '#FFFFFF' : '#000000' }}>
          ...
          >
            <Link to="/" style={{ textDecoration: "none", color: '#FFFFFF' }} > Ricky </Link>
          </Typography>
